...
if (isset($_POST['categoria'])) {
    ...
    $dataCategorias = CRUD("SELECT * FROM categorias WHERE categoria='$categoria'", "s");
} else {
    ...
    <div id="principal" class="container-fluid">
        ...
        <div class="card" style="margin-top:5px; margin-bottom: 5px;">
            <div class="card-header">
                <b>Panel Categorías</b> <b style="float:right;">Bienvenido/a</b>
            </div>
            <div class="card-body">
                <div class="table-responsive-xl">
                    <div class="row centrar">
                        <div class="col-md-6">
                            ...
                            <button type="button" class="btn btnModulosPrincipal" data-bs-toggle="modal" data-bs-target="#ModalInsertCategoria">
                        ...
                        <div class="col-md-6">
                            <form action="principal.php" method="POST">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1"><b>Buscar Categoría</b></span>
                                    <input type="text" class="form-control" placeholder="Ingrese Categoría" name="categoria">
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger centrar">
                            <b>No existen categorías registradas.....</b>
                        </div>
                    <?php endif ?>
                </div>
            </div>
